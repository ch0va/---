const ACTIVE_SLIDE_CLASSNAME = 'gallery-slider__active';

const slidesNodes = Array.from(document.querySelectorAll('.gallery-slider__images-box'));
const prevButtonNode = document.querySelector('.gallery-slider__control_prev');
const nextButtonNode = document.querySelector('.gallery-slider__control_next');
let activeId;
